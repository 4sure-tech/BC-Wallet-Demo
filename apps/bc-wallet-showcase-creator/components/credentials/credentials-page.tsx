  ...
  return (
    <div className="flex flex-col">
      <Header
        ...
        buttonBgColor="border-2 border-dark-border dark:border-dark-border cursor-pointer uppercase bg-background text-light-text dark:text-dark-text hover:bg-light-btn dark:hover:bg-dark-btn-hover font-bold py-2 px-2 transition"
