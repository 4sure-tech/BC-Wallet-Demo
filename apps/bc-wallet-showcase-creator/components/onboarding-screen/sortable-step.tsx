      ...
      <div className="bg-light-bg dark:bg-dark-bg flex flex-col w-full cursor-pointer" onClick={handleStepClick}>
        <div
          className={cn(
            ...
            isSelected ? 'border-foreground' : 'border-light-bg-secondary',
          )}
        >
          ...
          {myScreen.type === 'SERVICE' && myScreen.actions[0].actionType === StepActionType.AcceptCredential && (
            <>
              {!myScreen.actions[0].credentialDefinitionId ? (
